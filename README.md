...
```
```
python train_sup_crc100k.py \
    --log log/train_sup_lit.txt \
    --epochs 50 \
    --batch_size 128 \
    --lr 1e-3 \
    --query_num 50 \
    --seed 42 \
    --init_csv al_file/BMC_openpath_init.csv \
    --id_cls 3 6 8 \
    --query_times 5
```
<!-- python train_sup_crc100k.py --log log/train_sup_lit.txt --epochs 50 --batch_size 128 --lr 1e-3 --query_num 50 --seed 42 --init_csv al_file/BMC_openpath_init.csv --id_cls 3 6 8 --query_times 5 -->
<!-- python train_sup_crc100k.py --log log/train_sup_lit.txt --epochs 50 --batch_size 128 --lr 1e-3 --query_num 50 --seed 42 --init_csv al_file/BMC_openpath_init.csv --id_cls 1 5 7 --query_times 3 -->
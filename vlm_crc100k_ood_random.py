...
def zero_shot_inference_random(args, train_eval_loader, id_cls, model_type='BMC'):
    ...
    # text_prompt_random = [
    #     "An H&E image of fibrous tissue",
    #     "An H&E image of squamous epithelium",
    #     "An H&E image of glandular tissue",
    #     "An H&E image of necrotic tissue",
    #     "An H&E image of Nerves",
    #     "An H&E image of Vessels"
    # ]
    ...
    #                       'An H&E image of Submucosa',
    #                       'An H&E image of Inflammatory infiltrates']  # for [3, 6, 8], [6, 8]
    # # 针对 ID 类为 [1, 5, 7] (背景、肌肉、间质) 的修改版
    # text_prompt_random = [
    #     "An H&E image of lymphocytes",  # 原 ID 类 3，现在是干扰
    #     "An H&E image of normal mucosa",  # 原 ID 类 6，现在是干扰
    #     "An H&E image of adenocarcinoma epithelium",  # 原 ID 类 8，现在是干扰
    #     "An H&E image of squamous epithelium",
    #     "An H&E image of glandular tissue",
    #     "An H&E image of necrotic tissue",
    #     "An H&E image of Dysplasia",
    #     "An H&E image of Nerves",
    #     "An H&E image of Vessels",
    #     "An H&E image of Inflammatory infiltrates"
    # ]
    text_prompt_random = ['An H&E image of stroma', 'An H&E image of mucus',\
                          "An H&E image of fibrous", \
                          "An H&E image of squamous epithelium", "An H&E image of glandular tissue", \
...
if __name__ == "__main__":
    ...
    y_pred_raw, y_prob_raw, names, embeds = zero_shot_inference_random(args, train_eval_loader, id_cls,
    ...
    print(len(names_id_vlm), len(names_id_gt), len(list(set(names_id_gt) & set(names_id_vlm))), \
          len(list(set(names_id_gt) & set(names_id_vlm))) / len(names_id_vlm), 'vs.',
          len(train_id_files) / len(train_files))

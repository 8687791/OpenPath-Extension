...
class BMC_LIP_Vision_FT_Lit(L.LightningModule):
    def __init__(self, pretrain, args):
        ...
        self.fc = nn.Sequential(nn.ReLU(), nn.Dropout(0.5), nn.Linear(512, 256), nn.ReLU(), nn.Dropout(0.2), nn.Linear(256, args.num_class))
        self.args = args
...
class BMC_Vision_FT_SSL_CPS_Lit(L.LightningModule):
    def __init__(self, pretrain, num_class, args):
        ...
        self.fc2 = nn.Sequential(nn.ReLU(), nn.Dropout(0.5), nn.Linear(512, 256), nn.ReLU(), nn.Dropout(0.2), nn.Linear(256, num_class))
        self.args = args
        self.labeled_names = []
